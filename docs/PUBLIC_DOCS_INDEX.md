...
Current Wave 1 pass completes Workstation, Round Table, and Model stack/Invite Wing visual adaptations as manual static refinement only (no runtime/API/storage additions).
